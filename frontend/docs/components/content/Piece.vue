...
const fillColor = colorMode.value == "light" ? "white" : "black";

const inverted = computed(() => {
  return props.type.startsWith('N') || props.type === 'XNOR'
})
</script>
...
<template>
  ...
  <div v-if="shape == 'ANSI'">
    ...
    <svg v-else :id="type.toLowerCase()" width="128px" height="64px" viewBox="0 0 128 64" xmlns="http://www.w3.org/2000/svg">
      <g v-if="type == 'BUFFER' || type == 'NOT'">
        <path v-if="inverted" transform="translate(11,0)" :stroke=fillColor style="stroke-width:2;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
      ...
      <g v-if="type.includes('AND')">
        ...
        <path v-if="inverted" transform="translate(9,0)" :stroke=fillColor style="stroke-width:2;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
          d="M 80,25 A 4,4 0 1 1 72,25 A 4,4 0 1 1 80,25 z" />
        <path :fill=fillColor
      ...
      <g v-if="type.includes('OR')">
        ...
        <path v-if="inverted" transform="translate(10,0)" :stroke=fillColor style="stroke-width:2;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
          d="M 80,25 A 4,4 0 1 1 72,25 A 4,4 0 1 1 80,25 z" />
